		...
		<AnimatedModal visible={visible} onClose={onClose}>
			<View style={styles.content}>
				...
				<Text style={styles.body}>
					{movieTitle} hasn't released yet. It will appear on your watchlist when it airs.
				</Text>
				<TouchableOpacity style={styles.checkbox} onPress={() => setDontShowAgain(!dontShowAgain)}>
 ...
 */
export async function shouldShowUnreleasedModal(userId: string): Promise<boolean> {
	// Check cache first
